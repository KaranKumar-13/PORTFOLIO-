        ...
        <div className="portfolio">
            ...
            <section className="hero" id="hero">
                ...
                <div className="hero__book">
                    <img className="hero__book-bg" src="/book-bg.png" alt="book" />
                    <img className="hero__book-photo" src="/karan-photo.jpg" alt="Karan Kumar" />
                </div>

                {/* ── Photo visible on mobile (book is hidden) ── */}
                <img className="hero__photo-mobile" src="/karan-photo.jpg" alt="Karan Kumar" />
